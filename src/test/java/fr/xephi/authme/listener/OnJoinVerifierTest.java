...
public class OnJoinVerifierTest {
    ...
    @Test
    public void shouldKickNonRegistered() {
        // given
        ...
        try {
            ...
            assertThat(e.getReason(), equalTo(MessageKey.MUST_REGISTER_MESSAGE));
        }
    }
    ...
    public void shouldRejectTooLongName() {
        ...
        try {
            ...
            assertThat(e.getReason(), equalTo(MessageKey.INVALID_NAME_LENGTH));
        }
    }

    @Test
    public void shouldRejectTooShortName() {
        // given
        given(settings.getProperty(RestrictionSettings.MIN_NICKNAME_LENGTH)).willReturn(4);
        given(settings.getProperty(RestrictionSettings.MAX_NICKNAME_LENGTH)).willReturn(8);
        given(settings.getProperty(RestrictionSettings.ALLOWED_NICKNAME_CHARACTERS)).willReturn("[a-zA-Z0-9]+");
    ...
    public void shouldRejectNameWithInvalidCharacters() {
        ...
        try {
            ...
            assertThat(e.getReason(), equalTo(MessageKey.INVALID_NAME_CHARACTERS));
            assertThat(e.getArgs(), equalTo(new String[]{"[a-zA-Z0-9]+"}));
        }
    }
    ...
    @Test
    public void shouldRejectNameWithWrongCasing() {
        // given
        String name = "Tester";
        ...
        try {
            ...
            assertThat(e.getReason(), equalTo(MessageKey.INVALID_NAME_CASE));
            assertThat(e.getArgs(), equalTo(new String[]{"testeR", "Tester"}));
        }
        verifyNoInteractions(dataSource);
    }
    ...
    public void shouldRejectNameAlreadyOnline() {
        ...
        try {
            ...
            assertThat(e.getReason(), equalTo(MessageKey.USERNAME_ALREADY_ONLINE_ERROR));
        }
    }
    ...
    @Test
    public void shouldThrowForBannedCountry() {
        // given
        ...
        try {
            ...
            assertThat(e.getReason(), equalTo(MessageKey.COUNTRY_BANNED_ERROR));
        }
    }
